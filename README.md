...
* Review of save process, saving data is now hooked into the WP publish button

### Todo

* Make sure publish button PUBLISHES the post and does not set it to be a draft
